...
UINT32 OV13850V36_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 OV5670V36_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 S5K5E2YZ_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 S5K3L2XXV36_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 S5K3L2YY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 S5K5E8YX_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 S5K5E8YXV36_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
/*HI*/
...
{
/*IMX*/
#if defined(S5K3L2XX_MIPI_RAW)
    {S5K3L2_SENSOR_ID, SENSOR_DRVNAME_S5K3L2_MIPI_RAW, S5K3L2_MIPI_RAW_SensorInit},
#endif
#if defined(S5K3L2XXV36_MIPI_RAW)
    {S5K3L2XXV36_SENSOR_ID, SENSOR_DRVNAME_S5K3L2XXV36_MIPI_RAW, S5K3L2XXV36_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined(OV13850V36_MIPI_RAW)
    {OV13850V36_SENSOR_ID, SENSOR_DRVNAME_OV13850V36_MIPI_RAW,OV13850V36_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined(OV5670V36_MIPI_RAW)
    {OV5670V36MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5670V36_MIPI_RAW, OV5670V36_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined(S5K3L2YY_MIPI_RAW)
    {S5K3L2YY_SENSOR_ID, SENSOR_DRVNAME_S5K3L2YY_MIPI_RAW, S5K3L2YY_MIPI_RAW_SensorInit},
#endif
#if defined(S5K5E2YY_MIPI_RAW)
    {S5K5E2YY_SENSOR_ID, SENSOR_DRVNAME_S5K5E2YY_MIPI_RAW, S5K5E2YY_MIPI_RAW_SensorInit},
#endif
#if defined(S5K5E2YZ_MIPI_RAW)
    {S5K5E2YZ_SENSOR_ID, SENSOR_DRVNAME_S5K5E2YZ_MIPI_RAW, S5K5E2YZ_MIPI_RAW_SensorInit},
#endif
#if defined(S5K5E8YX_MIPI_RAW)
    {S5K5E8YX_SENSOR_ID, SENSOR_DRVNAME_S5K5E8YX_MIPI_RAW, S5K5E8YX_MIPI_RAW_SensorInit},
#endif
#if defined(S5K5E8YXV36_MIPI_RAW)
    {S5K5E8YXV36_SENSOR_ID, SENSOR_DRVNAME_S5K5E8YXV36_MIPI_RAW, S5K5E8YXV36_MIPI_RAW_SensorInit},
#endif
