...
void mt_power_off(void)
{
	printk("mt_power_off\n");
        ...
        /* [WA] HTC: rtc_bbpu power down , will cause cache flush problem.
                To reset boot reason before it for mrdump & htc reason. */
#ifdef CONFIG_MTK_AEE_MRDUMP
        mrdump_set_ramdump_reason(AEE_REBOOT_MODE_NORMAL ,"power_off");
#endif
...
#define MSDC_SDIO_FLAG    (MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED | MSDC_UHS1)
    ...
    struct msdc_hw msdc1_hw = {
        ...
        .flags                = MSDC_SYS_SUSPEND | MSDC_CD_PIN_EN | MSDC_REMOVABLE | MSDC_HIGHSPEED | MSDC_UHS1 |MSDC_DDR,    
    #else
        .flags                = MSDC_SYS_SUSPEND | MSDC_HIGHSPEED | MSDC_UHS1 |MSDC_DDR | MSDC_CD_PIN_EN,
    #endif
        .dat0rddly            = 0,
        .dat1rddly            = 0,
        .dat2rddly            = 0,
